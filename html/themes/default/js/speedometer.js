...
class Circle {
    ...
    drawIcon(icon, state=0) {
        const img = document.getElementById('sprite-speedometer');
 ...
 */
function draw(canvas_used, ctx_used, speedometerValue, tachometerValue, gasValue, mileage, turnSignals, iconStates) {
    canvas = canvas_used;
    ctx = ctx_used;
    clearCanvas();
